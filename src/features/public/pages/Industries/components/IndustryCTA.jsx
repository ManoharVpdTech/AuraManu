  ...
  return (
    <section className="py-32 bg-[#050B14] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center border border-primary/20 bg-card/10 backdrop-blur-sm p-12 md:p-20 rounded-2xl">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">Have an Industry-Specific Technology Challenge?</h2>
